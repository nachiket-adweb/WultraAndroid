...
import com.android.wultrausage.services.HucService
...
@Composable
fun HucScreen(navController: NavHostController) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text("Wultra - HttpsUrlConnection")
                }
            )
        },
    ) { innerPadding ->
                    ...
                    onClick = {
                        scope.launch(IO) {
                            try {
                                ...
                                isLoading = true
                                json = formatJson(HucService().getMyJsonText(wultraCertStore))
                            } catch (e: Exception) {
                                isLoading = false
                                json = e.localizedMessage?.toString() ?: "ERROR"
                                infoText = "info:: Error Occured"
